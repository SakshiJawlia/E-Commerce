  ...
  return (
    <div>
       <Repair className="my-20 mx-auto">
                ...
                <h2 className="md:text-5xl sm:text-4xl text-3xl text-white">Repair Services</h2>
                <h1 className="md:text-6xl sm:text-5xl text-2xl text-white">Up to <span className="text-red-800">70% Off</span>-All T-Shirts and Accessories </h1>
